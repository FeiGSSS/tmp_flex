...
from flexllmgen.utils import project_decode_latency
...
class HFLM(TemplateLM):
    ...
    def _detect_batch_size(self, requests=None, pos: int = 0):
        ...
        def forward_batch(batch_size):
            ...
            for _ in range(5):
                logits, _ = self._model_call(test_batch, **call_kwargs)
    ...
    def loglikelihood_rolling(
        ...
        for req_idx, (string,) in enumerate(
            ...
            rolling_token_windows: List[Tuple[List[int], List[int]]] = list(
                map(
                    eval_utils.utils.make_disjoint_window,
                    eval_utils.utils.get_rolling_token_windows(
    ...
    def _loglikelihood_tokens(
        ...
        for chunk in chunks:
            ...
            # eval_logger.info(f"batched_inps is: {batched_inps.shape} , {batched_inps}\n ========================")
    ...
    def aggregated_throughout_lantency(self, 
        ...
        if decoupled or loglikelihood:
            ...
            if loglikelihood:
                raise ValueError("loglikelihood's prefill can not be 0")
            prefill_latency, decode_latency, prefill_throughput, decode_throughput = 0, 0, 0, 0
            total_latency = time_costs[0]
            num_generated_tokens = num_prompts * gen_len
            total_throughput = num_generated_tokens / total_latency
