...
@register_model("flexllmgen", "flexllmgen-cxl", "flexllmgen_cxl", "flexllmgen-gpu", "flexllmgen_gpu")
class flexgen(TemplateLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        cache_size = self.opt_config.cache_bytes(self.num_prompts, self.prompt_len + self.gen_len)
        hidden_size = self.opt_config.hidden_bytes(self.num_prompts, self.prompt_len + self.gen_len)
        print(f"If num_prompts: {self.num_prompts}, prompt_len: {self.prompt_len}, gen_len: {self.gen_len}, cut_gen_len: {self.cut_gen_len}"
            f"model size: {self.opt_config.model_bytes()/GB:.3f} GB, "
